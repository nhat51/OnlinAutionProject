...
namespace OnlineAuction.Controllers
{
    public class SubCategoriesController : Controller
    {
        ...
        public SubCategoriesController(OnlineAuctionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Sub_Category_Name,CategoryID")] SubCategory subCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Sub_Category_Name,CategoryID")] SubCategory subCategory)
        {
