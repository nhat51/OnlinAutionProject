...
{
    public partial class NhatMigrate3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_BidderId",
                        column: x => x.BidderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BiddersId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BidPrice = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuctionDetails_AspNetUsers_BiddersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionDetails_BiddersId",
                table: "AuctionDetails",
                column: "BiddersId");
