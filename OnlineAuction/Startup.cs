...
namespace OnlineAuction
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<OnlineAuctionContext>(option=>
                option.UseSqlServer(Configuration.GetConnectionString("OnlineAuctionContextConnection")));
            services.AddDefaultIdentity<OnlineAuctionUser>().AddRoles<IdentityRole>().
