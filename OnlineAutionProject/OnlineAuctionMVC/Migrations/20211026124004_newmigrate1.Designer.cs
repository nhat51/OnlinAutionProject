...
namespace OnlineAuctionMVC.Migrations
{
    ...
    [Migration("20211026124004_newmigrate1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Bid_coin_pack", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Bid_coin_trans_log", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Bid_order", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Bid_order_log", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Bidder", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Product_category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Product_image", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Sub_category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Bid_order", b =>
                {
                    b.HasOne("OnlineAuctionMVC.Models.Bidder", "Bidder")
                        .WithMany("Bid_Orders")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Bid_order_log", b =>
                {
                    b.HasOne("OnlineAuctionMVC.Models.Bidder_bid_regist", "Bidder_Bid_Regist_ID")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Product", b =>
                {
                    b.HasOne("OnlineAuctionMVC.Models.Sub_category", "Sub_Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Product_image", b =>
                {
                    b.HasOne("OnlineAuctionMVC.Models.Product", "Product_ID")
            ...
            modelBuilder.Entity("OnlineAuctionMVC.Models.Sub_category", b =>
                {
                    b.HasOne("OnlineAuctionMVC.Models.Product_category", "Category")
